import { getPagedRegistrations, getRegistrationPages } from "@/app/lib/database/package-registration";
...
export default async function Page({searchParams}: {
    ...
    const packageRegistrations = await getPagedRegistrations(query, currentPage);

    return (
        <div className="p-12">
            <div className="flex w-full items-center justify-between">
                <h1 className="text-2xl">Riwayat Pendaftaran</h1>
            </div>
